...
'in': 'in',
'Index': '索引',
'Input the words in TextArea Below or upload the file!': 'Input the words in TextArea Below or upload the file!',
'insert new': '插入新纪录',
...
'please upload chatlog file:': '请上传聊天记录文件:',
'Plugins': 'Plugins',
'Powered by': '基于下列技术构建：',
'Preface': 'Preface',
...
'This is only a demo...': 'This is only a demo...',
...
'User ID': '用户编号',
'Value not in database': '在数据库查不到对应的值',
